...
export default function Header({ title, subtitle }: { title?: string; subtitle?: string }) {
  ...
  const showEmployeeClock = Boolean(user) && !hasClientPortalAccess(user) && !pathname.startsWith('/client');
  ...
  const iconButtonClass = cn(
    'inline-flex h-11 w-11 items-center justify-center rounded-[var(--radius-md)] border border-[var(--border)] bg-[var(--card-bg)] text-[var(--icon-color)]',
  ...
  return (
    ...
    >
      <div className="flex min-w-0 flex-1 items-center gap-3">
        <button
          type="button"
          className={cn(iconButtonClass, 'min-w-11 shrink-0')}
      ...
      <div className="flex shrink-0 items-center gap-2">
        <button
          ...
          className="hidden h-11 items-center gap-2 rounded-[var(--radius-md)] border border-[var(--border)] bg-[var(--card-bg)] px-3 text-sm text-[var(--muted)] transition-[background-color,border-color,color,transform] duration-150 ease-[var(--ease-out)] hover:border-[var(--muted)] hover:bg-[var(--surface-hover)] hover:text-[var(--foreground)] active:translate-y-px sm:flex"
        ...
        <button
          ...
          className="inline-flex h-11 w-11 items-center justify-center overflow-hidden rounded-[var(--radius-md)] border border-[var(--border)] bg-[var(--card-bg)] transition-[border-color,transform] duration-150 ease-[var(--ease-out)] hover:border-[var(--muted)] active:translate-y-px active:scale-[0.98] focus-visible:ring-2 focus-visible:ring-[var(--accent)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--background)]"
