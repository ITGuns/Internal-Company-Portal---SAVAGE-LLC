...
import { ClientProject, ClientTicket } from "@/lib/client-portal";
import {
            ...
            >
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0">
                  ...
                  <div className="mt-2 flex flex-wrap gap-1.5 text-[10px] font-medium text-[var(--muted)]">
                    <span className="rounded-full bg-[var(--card-surface)] px-2 py-0.5">
                      {getClientTicketAssigneeName(ticket, users)}
                    </span>
                    <span className="max-w-full truncate rounded-full bg-[var(--card-surface)] px-2 py-0.5">
                      {getClientTicketProjectName(ticket, projects)}
                    </span>
                    <span className={`rounded-full px-2 py-0.5 ${slaBadgeClasses[slaState.tone]}`}>
                      {slaState.label}
                    </span>
                  </div>
