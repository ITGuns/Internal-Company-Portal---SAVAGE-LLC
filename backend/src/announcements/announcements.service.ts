...
function formatAnnouncementCategoryLabel(category?: string) {
    switch (category) {
        case 'company-news':
            return 'Announcement'
        case 'shoutouts':
        ...
        default:
            return (category || 'Announcement')
                ...
                .replace(/[-_]+/g, ' ')
                .replace(/\s+/g, ' ')
                .replace(/\b\w/g, (letter) => letter.toUpperCase()) || 'Announcement'
    }
}
...
export class AnnouncementsService {
    ...
    async create(data: CreateAnnouncementDto) {
        ...
        notificationService.broadcast({
            ...
            title: `New ${formatAnnouncementCategoryLabel(data.category)}: ${announcement.title}`,
